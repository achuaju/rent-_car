...
class CarListScreen1 extends StatefulWidget {

  @override
  _CarListScreen1State createState() => _CarListScreen1State();
}


class _CarListScreen1State extends State<CarListScreen1> {
  String searchQuery = '';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: Colors.grey.shade400, // Blue background
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.all(16.0), // Add padding to the text field
                        ),
          ...
          Expanded(
            child: CarGrid(searchQuery: searchQuery, sortOption: selectedSortOption),
          ),
        ],
      ),
        ...
        onTap: (index) {
          switch (index) {
            case 0:
              ...
              break;
            case 1:
              Navigator.pushReplacementNamed(context, '/booking'); // Navigate to Booking
              break;
            case 2:
  ...
  Widget build(BuildContext context) {
    ...
    switch (sortOption) {
      case 'Price: Low to High':
        orderByQuery = carsCollection.orderBy('price', descending: false);
        break;
      case 'Price: High to Low':
        orderByQuery = carsCollection.orderBy('price', descending: true);
        break;
      case 'Newest First':
        orderByQuery = carsCollection.orderBy('timestamp', descending: true);
        break;
      case 'Oldest First':
        orderByQuery = carsCollection.orderBy('timestamp', descending: false);
        break;
      default:
        orderByQuery = carsCollection;
    }
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        var filteredDocs = snapshot.data!.docs.where((doc) {
          ...
          return carName.toLowerCase().contains(searchQuery.toLowerCase());
        }).toList();
